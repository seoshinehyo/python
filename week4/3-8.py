# 3.8 (1) 입력 받은 세 자리 정수를 역순으로 출력하는 프로그램
...
# 3.8 (2) 입력 받은 세 자리 정수를 거꾸로 출력하는 프로그램
print(f'(2) 거꾸로 출력한 3자리 숫자 : {num_1}{num_10}{num_100}') # 거꾸로 출력

print('거꾸로 출력한 3자리 숫자 : {0}{0}{2}'.format(num_1, num_10, num_100))