...
longest_fruit = [fruit for fruit in fruit_list if len(fruit) == max_length]   # 가장 긴 문자열을 가진 과일들을 원소로 갖는 리스트

print(f'가장 길이가 긴 문자열 :, {longest_fruit[0]}, {longest_fruit[1]}')    # 가장 길이가 긴 과일 출력
